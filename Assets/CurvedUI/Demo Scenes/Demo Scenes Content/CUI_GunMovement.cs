...
namespace CurvedUI
{
    ...
    public class CUI_GunMovement : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //if (GameManager.Instance._GamePlayModle == TheGameCore.GameStatic.GamePlayModle.VR)
            //{
            //    CurvedUIInputModule.CustromControllerButtonDown = Pvr_UnitySDKAPI.Controller.UPvr_GetKeyDown(0, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
            //}
            //else
            //{
            //    CurvedUIInputModule.CustromControllerButtonDown = Input.GetMouseButton(0);
