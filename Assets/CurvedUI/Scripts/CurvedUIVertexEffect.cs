...
#region CHECKS
        ...
        void CheckTextFontMaterial()
        {
            ...
            if (myText)
            {
                Vector4 _v4= new Vector4(savedTextUV0.x, savedTextUV0.y, 0, 0);
                if (myText.cachedTextGenerator.verts.Count > 0 && myText.cachedTextGenerator.verts[0].uv0 != _v4)
                {
...
#region TESSELATION
        ...
        UIVertex TesselateQuad(UIVertex[] quad, float x, float y)
        {
            ...
            Vector4 uv0 = Vector4.zero, uv1 = Vector4.zero;
