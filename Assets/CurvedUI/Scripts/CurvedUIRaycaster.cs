...
namespace CurvedUI
{
    public class CurvedUIRaycaster : GraphicRaycaster
    {
        ...
        protected void CreateCollider(Vector3 _v3)
        {
            ...
            switch (mySettings.Shape)
            {
                ...
                case CurvedUISettings.CurvedUIShape.CYLINDER:
                {
                    ...
                    if (mySettings.ForceUseBoxCollider || GetComponent <Rigidbody>() != null || GetComponentInParent<Rigidbody>() != null)
                    {
                        if (colliderContainer != null)
                         ...
                         colliderContainer = CreateConvexCyllinderCollider(_v3);
                    }
                ...
                case CurvedUISettings.CurvedUIShape.CYLINDER_VERTICAL:
                {
                    ...
                    if (mySettings.ForceUseBoxCollider || GetComponent<Rigidbody>() != null || GetComponentInParent<Rigidbody>() != null)
                    {
                        ...
                        colliderContainer = CreateConvexCyllinderCollider(_v3,true);
                    }
                    else // create a faster single mesh collier when possible
                    {
        ...
        GameObject CreateConvexCyllinderCollider(Vector3 _v3, bool vertical = false)
        {
            ...
            for(int i = 0; i < verts.Count-1; i++)
            {
                ...
                if (vertical) 
                {
                    ...
                    newBox.transform.localScale = new Vector3(0.1f+ _v3.x, Vector3.Distance(Vertices[0], Vertices[1])+ _v3.y, Vector3.Distance(verts[i + 1], verts[i])+ _v3.z);
        ...
        public void RebuildCollider(Vector3 _v3)
        {
            cyllinderMidPoint = new Vector3(0, 0, -mySettings.GetCyllinderRadiusInCanvasSpace());
            CreateCollider(_v3);
        }
